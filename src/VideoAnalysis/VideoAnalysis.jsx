...
//       if (curRegion.id === region.id) return true;
//     }
...
//   const getRegionId = () => {
//     if (regions.length === 0) return 'region0';
...
//       const data = boundingBoxes.find(
//         x => x.timestamp === Math.round(currentTime),
//       );
...
//         (video.offsetWidth * zoomLevel - containerWidth) / 2,
//         0,
//       );
//       const minLeft = Math.min(
//         0,
//         (containerWidth - video.offsetWidth * zoomLevel) / 2,
//       );
//       const maxTop = Math.max(
//         (video.offsetHeight * zoomLevel - containerHeight) / 2,
//         0,
//       );
//       const minTop = Math.min(
//         0,
//         (containerHeight - video.offsetHeight * zoomLevel) / 2,
//       );
...
//     if (waveSurfer != null) {
//       waveSurfer.destroy();
//       if (surferTimeline != null) surferTimeline.destroy();
//     }
...
//           if (currentRect.id === rect.id) return { ...rect };
//           return currentRect;
//         });
...
//       if (estimatedFPS > 0) {
//         const proposedTime =
//           videoRef.current.currentTime - numFrames / estimatedFPS;
//         if (proposedTime >= 0) {
//           handlePause();
...
//     if (frameCounter === 0) videoRef.current.muted = true;
...
//         context.rect(
//           subjectRect[0] * widthRatio,
//           subjectRect[1] * heightRatio,
//           subjectRect[2] * widthRatio,
//           subjectRect[3] * heightRatio,
//         );
//         context.strokeStyle = 'green';
//         context.lineWidth = '3';
//         context.stroke();
//         return;
//       }
//       let data = frameBoundingBoxes.find(
//         x => x.frameNumber === Math.round(currentFrame),
//       );
...
//           if (subjectIDs.includes(data[index].id)) color = 'green';

//           if (isRegionsScreen && color !== 'green') continue;
//           context.beginPath();
//           // context.rect(rect.x+220, rect.y-850, rect.width, rect.height/2);
//           context.rect(
//             rect.x * widthRatio,
...
//               x =
//                 rect.x * widthRatio <= 10
//                   ? rect.x * widthRatio + 50
//                   : rect.x * widthRatio;
//               y =
//                 rect.y * heightRatio <= 10
//                   ? rect.y * heightRatio + 50
//                   : rect.y * heightRatio;
...
//           if (
//             !(
//               Math.abs(meanX - d.x) > meanX / 2 ||
//               Math.abs(meanY - d.y) > meanY / 2 ||
//               Math.abs(meanWidth - d.width) > meanWidth / 2 ||
//               Math.abs(meanHeight - d.height) > meanHeight / 2
//             )
//           ) {
...
//             finalRight =
//               finalRight < d.width + d.x ? d.width + d.x : finalRight;
//             finalBottom =
//               finalBottom < d.height + d.y ? d.height + d.y : finalBottom;
...
//     const otherRects = getCurRect().filter(
//       currentRect => currentRect.id !== rect.id,
//     );
...
//         if (
//           rect.y >= otherRect.y - 50 &&
//           rect.y <= otherRect.y + otherRect.height + 50
//         )
//           return true;
//         if (
//           rect.height + rect.y >= otherRect.y - 50 &&
//           rect.height + rect.y <= otherRect.y + otherRect.height + 50
//         )
//           return true;
//         return false;
//       };
...
//         if (
//           rect.x >= otherRect.x - 50 &&
//           rect.x <= otherRect.x + otherRect.width + 50
//         )
//           return true;

//         if (
//           rect.x + rect.width >= otherRect.x - 50 &&
//           rect.x + rect.width <= otherRect.x + otherRect.width + 50
//         )
//           return true;
...
//       if (checkYOverlap() && checkXOverlap()) return true;
//     }
...
//       <div>
//         <button
//           className="px-4 py-2 rounded-md bg-black text-white mt-5 text-2xl"
//           onClick={() => {
...
//       {isRegionsScreen && (
//         <div
//           className="video-container bg-gray-200 flex-grow"
//           style={videoStyle}
//         >
//           <video
//             ref={videoRef}
...
//           {jsonParserAvailable && (
//             <div className="overflow-y-auto overflow-x-scroll flex-shrink-0 h-screen">
...
//                           value={
//                             Math.round(
//                               (value.frameNumber / estimatedFPS) * 100,
//                             ) / 100
//                           }
//                         />
//                       </td>
...
//                         <button
//                           className={
//                             subjectIDs.includes(key)
//                               ? 'py-2 m-2 rounded-md px-4 text-center bg-lime-500'
//                               : 'py-2 m-2 rounded-md px-4 text-center bg-sky-300'
//                           }
//                           onClick={() => {
...
//         <div className={'text-xl px-2 border-2'}>
...
//       <div>
//         <button
//           className={'px-4 py-2 rounded-md bg-black text-white text-2xl mb-10'}
//           onClick={() => {
//             processVideo();
//           }}
//         >
...
//       {waveLoading && <div>Wave loading ... </div>}

//       {!isRegionsScreen && (
//         <div className={'w-[70%]'} id={'subject-selection'}></div>
//       )}

//       {isRegionsScreen && <div className={'w-[70%]'} id={'timeline'}></div>}
...
//                     </button>
//                   </td>
//                   <td className="py-2 px-4 w-[15%] outline-2 text-center">
//                     <input
//                       className={'text-center'}
//                       value={region.start}
//                       onChange={e => {
...
//                     />
//                   </td>
//                   <td className="py-2 px-4 w-[15%] text-center">
//                     <input
//                       className={'text-center'}
//                       value={region.end}
//                       onChange={e => {
...
//         <div>
//           <button
//             className={'p-4 bg-blue-300 mb-20'}
//             onClick={() => {
//               setRegions(
//                 regions.concat({
//                   start: 0,
